...
public class Main {
    public static void main(String[] args) {
        ...
        // Disallow users to edit the text area
        ...
        submit_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    BigNumber val = new BigNumber(text_field_0.getText(), text_field_1.getText());

                    text_area.setText("= " + val.add(text_field_0.getText(), text_field_1.getText()));
                } catch (Exception er) {
